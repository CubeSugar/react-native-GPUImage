...
const GPUImageScreenBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
void main() {
    ...
    gl_FragColor = whiteColor - (whiteColor - texColor1) * (whiteColor - texColor0);
}
`;

export const GPUImageScreenBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageScreenBlendFragShaderString}
                input2nd={input2nd}
