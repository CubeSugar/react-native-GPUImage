...
const GPUImageNormalBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
void main() {
    ...
    vec4 outputColor;
    outputColor.rgb = texColor0.rgb * texColor0.a + texColor1.rgb * texColor1.a * (1.0 - texColor0.a);
    outputColor.a   = texColor0.a + texColor1.a * (1.0 - texColor0.a);

    gl_FragColor = outputColor;
}
`;

export const GPUImageNormalBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageNormalBlendFragShaderString}
                input2nd={input2nd}
