...
const GPUImageSubtractBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
void main() {
    ...
    gl_FragColor = vec4(texColor0.rgb - texColor1.rgb, texColor0.a);
}
`;

export const GPUImageSubtractBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageSubtractBlendFragShaderString}
                input2nd={input2nd}
