...
const GPUImageLinearBurnBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
void main() {
    ...
    gl_FragColor = vec4(clamp(texColor0.rgb + texColor1.rgb - vec3(1.0), vec3(0.0), vec3(1.0)), texColor0.a);
}
`;

export const GPUImageLinearBurnBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageLinearBurnBlendFragShaderString}
                input2nd={input2nd}
