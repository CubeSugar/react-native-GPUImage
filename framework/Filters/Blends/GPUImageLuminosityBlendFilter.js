...
const GPUImageLuminosityBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
...
void main() {
    ...
    gl_FragColor = vec4(base.rgb * (1.0 - overlay.a) + setLum(base.rgb, dot(overlay.rgb, W)) * overlay.a, base.a);
}
`;

export const GPUImageLuminosityBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageLuminosityBlendFragShaderString}
                input2nd={input2nd}
