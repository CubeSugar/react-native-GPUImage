...
const GPUImageSaturationBlendFragShaderString = GPUImageTwoInputFragShaderPredefineString + `
...
void main() {
    ...
    gl_FragColor = vec4(base.rgb * (1.0 - overlay.a) + setLum(setSat(base.rgb, sat(overlay.rgb)), dot(base.rgb, W)) * overlay.a, base.a);
}
`;

export const GPUImageSaturationBlendFilter = GL.createComponent(
    ({ children, input2nd, input2ndScale}) => {
        return (
            <GPUImageTwoInputFilter
                frag={GPUImageSaturationBlendFragShaderString}
                input2nd={input2nd}
